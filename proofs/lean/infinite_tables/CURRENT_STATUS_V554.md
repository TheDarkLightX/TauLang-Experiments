...
| `safe_table_select_revision` | checked | Safe select and safe revision are first-class constructors in the table grammar, preserving monotonicity, omega-continuity, and the fixed-point receipt. |
...
- lower the safe fragment into Tau runtime artifacts
